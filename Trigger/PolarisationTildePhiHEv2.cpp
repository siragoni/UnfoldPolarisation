...
void fitJPsiTemplateMC(const int selectionFlag = 0){
  ...
  // }
  fCohJpsiToMu        = (TH1F*)listingsMC[0]->FindObject(Form("fInvariantMassDistributionOnlyTildePhiHeFrameTwentyfiveBinsHv2_%d", selectionFlag));
  // fCohPsi2sToMu       = (TH1F*)listingsMC[1]->FindObject(Form("fInvariantMassDistributionOnlyTildePhiHeFrameTwentyfiveBinsH_%d", selectionFlag));
  ...
  // fTwoGammaToMuMedium = (TH1F*)listingsMC[6]->FindObject(Form("fInvariantMassDistributionOnlyTildePhiHeFrameTwentyfiveBinsH_%d", selectionFlag));
...
void fitJPsiTemplate(const int selectionFlag, Int_t SignalRangeModeFlag = 0){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject( Form("fInvariantMassDistributionOnlyTildePhiHeFrameTwentyfiveBinsHv2_%d", selectionFlag) );
  ...
  TDatime d;
  if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/TildePhiHEv2/TildePhiHe_%d.png",        d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/TildePhiHEv2/TildePhiHe_%d_Range1.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/TildePhiHEv2/TildePhiHe_%d_Range2.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/TildePhiHEv2/TildePhiHe_%d_Range3.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/TildePhiHEv2/TildePhiHe_%d_Range4.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/TildePhiHEv2/TildePhiHe_%d_Range5.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else                                 { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/TildePhiHEv2/TildePhiHe_%d.png",        d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }


  // gPad->SaveAs(Form("pngResults/TildePhiHe_%d.png", selectionFlag), "recreate");
  // if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_%d.png",        selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_%d_Range1.png", selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_%d_Range2.png", selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_%d_Range3.png", selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_%d_Range4.png", selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/TildePhiHe_%d_Range5.png", selectionFlag), "recreate"); }
  // else                                 { gPad->SaveAs(Form("pngResults/TildePhiHe_%d.png",        selectionFlag), "recreate"); }
...
void CreateCosThetaTh1(const char* AnalysisName, Int_t TriggerFlag, Int_t SignalRangeMode = 0){
  ...
  // TFile f("pngResults/TildePhiHeFrame.root", "recreate");
  ...
  if      ( SignalRangeMode == 0 ) {
    TDatime d;
    TFile f(Form("TriggerUncert/PolTrigger%d/TildePhiHEv2.root", TriggerFlag), "recreate");
    // TFile f("pngResults/TildePhiHeFrame.root",   "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_1.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_2.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_3.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_4.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/TildePhiHeFrame_5.root", "recreate");
    TildePhiAfterSignalExtractionH      ->Write();
    TildePhiGammaGammaH                 ->Write();
    TildePhiAfterSignalExtractionErrorsH->Write();
    TildePhiGammaGammaErrorsH           ->Write();
