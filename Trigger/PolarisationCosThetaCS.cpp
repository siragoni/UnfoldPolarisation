...
void fitJPsiTemplate(const int selectionFlag, Int_t SignalRangeModeFlag = 0){
  ...
  if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_%d.png",        selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_%d_Range1.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_%d_Range2.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_%d_Range3.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_%d_Range4.png", selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/CosThetaCs_%d_Range5.png", selectionFlag), "recreate"); }
  else                                 { gPad->SaveAs(Form("pngResults/CosThetaCs_%d.png",        selectionFlag), "recreate"); }
...
void CreateCosThetaTh1(const char* AnalysisName, Int_t TriggerFlag, Int_t SignalRangeMode = 0){
  ...
  if      ( SignalRangeMode == 0 ) {
    TFile f(Form("TriggerUncert/PolTrigger%d/CosThetaCsFrame.root", TriggerFlag),   "recreate");
    ...
    TFile f("pngResults/CosThetaCsFrame_1.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/CosThetaCsFrame_2.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/CosThetaCsFrame_3.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/CosThetaCsFrame_4.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/CosThetaCsFrame_5.root", "recreate");
    CosThetaAfterSignalExtractionH      ->Write();
    CosThetaGammaGammaH                 ->Write();
    CosThetaAfterSignalExtractionErrorsH->Write();
    CosThetaGammaGammaErrorsH           ->Write();
