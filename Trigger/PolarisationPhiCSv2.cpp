...
void fitJPsiTemplateMC(const int selectionFlag = 0){
  ...
  // }
  fCohJpsiToMu        = (TH1F*)listingsMC[0]->FindObject(Form("fInvariantMassDistributionOnlyPhiCsFrameTwentyfiveBinsHv2_%d", selectionFlag));
...
void fitJPsiTemplate(const int selectionFlag, Int_t SignalRangeModeFlag = 0){
  ...
  fInvariantMassDistributionH = (TH1F*)listings->FindObject( Form("fInvariantMassDistributionOnlyPhiCsFrameTwentyfiveBinsHv2_%d", selectionFlag) );
  ...
  latex->DrawLatex(0.55,0.78,Form("#color[2]{%.3f < #phi < %.3f}", 2.*TMath::Pi()*(Double_t)selectionFlag / 25., 2.*TMath::Pi()*((Double_t)selectionFlag + 1.00) / 25.));
  ...
  TDatime d;
  if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/PhiCSv2/PhiCs_%d.png",        d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/PhiCSv2/PhiCs_%d_Range1.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/PhiCSv2/PhiCs_%d_Range2.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/PhiCSv2/PhiCs_%d_Range3.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/PhiCSv2/PhiCs_%d_Range4.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/PhiCSv2/PhiCs_%d_Range5.png", d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }
  else                                 { gPad->SaveAs(Form("pngResults/%d-%2.2d-%2.2d/PhiCSv2/PhiCs_%d.png",        d.GetYear(), d.GetMonth(), d.GetDay(), selectionFlag), "recreate"); }



  // gPad->SaveAs(Form("pngResults/PhiCs_%d.png", selectionFlag), "recreate");
  // if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("pngResults/PhiCs_%d.png",        selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("pngResults/PhiCs_%d_Range1.png", selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("pngResults/PhiCs_%d_Range2.png", selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("pngResults/PhiCs_%d_Range3.png", selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("pngResults/PhiCs_%d_Range4.png", selectionFlag), "recreate"); }
  // else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("pngResults/PhiCs_%d_Range5.png", selectionFlag), "recreate"); }
  // else                                 { gPad->SaveAs(Form("pngResults/PhiCs_%d.png",        selectionFlag), "recreate"); }
...
void CreateCosThetaTh1(const char* AnalysisName, Int_t TriggerFlag, Int_t SignalRangeMode = 0){
  ...
  for (size_t iCosThetaBins = 0; iCosThetaBins < 25; iCosThetaBins++) {
    // for (size_t iPhiBins = 0; iPhiBins < 10; iPhiBins++) {
      ...
      PhiAfterSignalExtractionH->Fill(  PhiAfterSignalExtractionH->GetBinCenter( iCosThetaBins + 1 ), JPsiPeakValue );
      PhiGammaGammaH           ->Fill(  PhiGammaGammaH           ->GetBinCenter( iCosThetaBins + 1 ), BkgValue      );

      PhiAfterSignalExtractionErrorsH->Fill(  PhiAfterSignalExtractionErrorsH->GetBinCenter( iCosThetaBins + 1 ), JPsiPeakValue );
      PhiGammaGammaErrorsH           ->Fill(  PhiGammaGammaErrorsH           ->GetBinCenter( iCosThetaBins + 1 ), BkgValue      );
      PhiGammaGammaErrorsH           ->SetBinError(   iCosThetaBins + 1 , BkgValueError    );
      PhiAfterSignalExtractionErrorsH->SetBinError(   iCosThetaBins + 1 , JPsiPeakValueErr );
  ...
  if      ( SignalRangeMode == 0 ) {
    TDatime d;
    TFile f(Form("TriggerUncert/PolTrigger%d/PhiCSv2.root", TriggerFlag)  , "recreate");
    // TFile f("pngResults/PhiCsFrame.root",   "recreate");
    ...
    TFile f("pngResults/PhiCsFrame_1.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/PhiCsFrame_2.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/PhiCsFrame_3.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/PhiCsFrame_4.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
    ...
    TFile f("pngResults/PhiCsFrame_5.root", "recreate");
    PhiAfterSignalExtractionH      ->Write();
    PhiGammaGammaH                 ->Write();
    PhiAfterSignalExtractionErrorsH->Write();
    PhiGammaGammaErrorsH           ->Write();
