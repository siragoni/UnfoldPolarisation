...
void PolarisationHeMinuit2D(Int_t FitRangeMode = 0, Int_t Iterations = 1, Int_t StripeMode = 0 ){
  ...
  for (Int_t i = 4; i < 20; i++) {
    f[i]         = new TFile(Form("TriggerCoarse/TriggerHE5/Unfolding/UnfoldHeV2_%d.root", i));
  ...
  gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/Fitting/residual-refolded-data-%d.pdf", Iterations), "recreate");
  ...
  gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/Fitting/2Dmaps-data-%d.pdf", Iterations), "recreate");
  ...
  histo2->Fit("Model", "R");
  gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/Fitting/3D-data-%d.pdf", Iterations), "recreate");
  ...
  gPad->SaveAs("TriggerCoarse/TriggerHE5/Fitting/residuals-data.pdf", "recreate");
