...
void fitJPsiTemplate( const int selectionFlag, const int selectionFlag2, Int_t SignalRangeModeFlag = 0){
  ...
  if      ( SignalRangeModeFlag == 0 ) { gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/pngResults/2DHe_%d_%d.png",        selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 1 ) { gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/pngResults/2DHe_%d_%d_Range1.png", selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 2 ) { gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/pngResults/2DHe_%d_%d_Range2.png", selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 3 ) { gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/pngResults/2DHe_%d_%d_Range3.png", selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 4 ) { gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/pngResults/2DHe_%d_%d_Range4.png", selectionFlag, selectionFlag2), "recreate"); }
  else if ( SignalRangeModeFlag == 5 ) { gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/pngResults/2DHe_%d_%d_Range5.png", selectionFlag, selectionFlag2), "recreate"); }
  else                                 { gPad->SaveAs(Form("TriggerCoarse/TriggerHE5/pngResults/2DHe_%d_%d.png",        selectionFlag, selectionFlag2), "recreate"); }
...
void CreateCosThetaTh2(){
  ...
  parsedMC = new TFile("TriggerCoarse/TriggerHE5/ClosureYields/CohHe.root");
  ...
  fileList = new TFile("TriggerCoarse/TriggerHE5/CohHe_data2.root");
  ...
  // for (Int_t iCosThetaBins = 9; iCosThetaBins < 10; iCosThetaBins++) {
    ...
    TFile f(Form("TriggerCoarse/TriggerHE5/RawYieldsHeV4_%d.root", iCosThetaBins),   "recreate");
