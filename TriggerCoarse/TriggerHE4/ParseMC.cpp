...
void ParseMC(){
  ...
  TFile *SavingFile = new TFile("TriggerCoarse/TriggerHE4/ClosureYields/CohHe.root", "RECREATE");
  PhiRecH->Write();
  PhiRecHH->Write();
  PhiGenH->Write();
  PhiGenHH->Write();
  ...
  TFile* parsedMC = new TFile("TriggerCoarse/TriggerHE4/ClosureYields/CohHe.root");
  ...
  for (Int_t iCosThetaBins5 = 4; iCosThetaBins5 < 20; iCosThetaBins5++) {
    ...
    // TFile f(Form("TriggerCoarse/TriggerHE4/ClosureYields/MonteCarloYieldsHe_%d.root", iCosThetaBins5),   "recreate");
