...
// Description
// --------------------------
// For the first time we try
// to fix the Normalisation
// by using the integral of
// the function over the
// 2D histogram.
//
// However, the reach in
// CosTheta is not over the
// complete angle.
//
// It turns out that using
// the slices 6 to 17 included,
// means an integration from
// arccos(-0.5) to arccos(0.5)
//
// This means that the integral
// is a function of both LambdaTheta
// and the Normalisation:
//
//      (-0.0905861*LambdaTheta - 1.0472) * N
// I = ---------------------------------------
//                    LambdaTheta + 3
//
//      (0.0833333*LambdaTheta + 1) * N
// I = ---------------------------------------
//                    LambdaTheta + 3
