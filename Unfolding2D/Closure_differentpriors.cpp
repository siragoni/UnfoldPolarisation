...
Double_t weight_prior(Double_t CosTheta){
  Double_t CosSquaredTheta      = CosTheta * CosTheta;
  Double_t returnValue = (1. + 0.8 * CosSquaredTheta)/(2.05282);
  return returnValue;
}
...
Double_t weight_prior2D(Double_t Phi, Double_t CosTheta){
  ...
  // Double_t partialPhi           = 0.001 * SinSquaredTheta * CosOfTwoPhi;
  Double_t partialPhi           = 0.01 * SinSquaredTheta * CosOfTwoPhi;
  ...
  // Double_t partialMix           = 0.01 * SinOfTwoTheta * CosPhi;
  Double_t partialMix           = 0.1 * SinOfTwoTheta * CosPhi;


  Double_t sumOfTheSubFits      = partialTheta + partialPhi + partialMix;
  // Double_t FinalResult          = 1. * sumOfTheSubFits / ( 3. + 0.6  );
  Double_t FinalResult          = 1. * sumOfTheSubFits / ( 3. + 0.95  );
  return   FinalResult;
