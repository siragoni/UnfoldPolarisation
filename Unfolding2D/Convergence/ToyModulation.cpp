...
void ToyModulation(Int_t Stripe = 14){
  ...
  for (Int_t i = 5; i < 20; i++) {
    fData[i]  = new TFile(Form("SignalExtraction/MonteCarloYieldsHe_phimodulation_%d.root", i));
  ...
  for (Int_t i = 1; i < 101; i++) {
    cout << "i*20 = " << i*20 << endl;
    unfold[i-1]                = RooUnfoldBayes(h[Stripe], hdata_formatted, i*20);
  ...
  Covariance[0]  = new TMatrixD(1,1);
  Covariance[1]  = new TMatrixD(1,1);
  Covariance[2]  = new TMatrixD(1,1);
  Covariance[3]  = new TMatrixD(1,1);
  Covariance[4]  = new TMatrixD(1,1);
  Covariance[5]  = new TMatrixD(6,6);
  Covariance[6]  = new TMatrixD(6,6);
  Covariance[7]  = new TMatrixD(12,12);
  Covariance[8]  = new TMatrixD(12,12);
  Covariance[9]  = new TMatrixD(24,24);
  Covariance[10] = new TMatrixD(24,24);
  Covariance[11] = new TMatrixD(24,24);
  Covariance[12] = new TMatrixD(24,24);
  Covariance[13] = new TMatrixD(24,24);
  Covariance[14] = new TMatrixD(24,24);
  Covariance[15] = new TMatrixD(12,12);
  Covariance[16] = new TMatrixD(12,12);
  Covariance[17] = new TMatrixD(6,6);
  Covariance[18] = new TMatrixD(6,6);
  Covariance[19] = new TMatrixD(1,1);
  Covariance[20] = new TMatrixD(1,1);
  Covariance[21] = new TMatrixD(1,1);
  Covariance[22] = new TMatrixD(1,1);
  Covariance[23] = new TMatrixD(1,1);
  TMatrixD** CovarianceCopy;
  CovarianceCopy = new TMatrixD*[24];
  CovarianceCopy[0]  = new TMatrixD(1,1);
  CovarianceCopy[1]  = new TMatrixD(1,1);
  CovarianceCopy[2]  = new TMatrixD(1,1);
  CovarianceCopy[3]  = new TMatrixD(1,1);
  CovarianceCopy[4]  = new TMatrixD(1,1);
  CovarianceCopy[5]  = new TMatrixD(6,6);
  CovarianceCopy[6]  = new TMatrixD(6,6);
  CovarianceCopy[7]  = new TMatrixD(12,12);
  CovarianceCopy[8]  = new TMatrixD(12,12);
  CovarianceCopy[9]  = new TMatrixD(24,24);
  CovarianceCopy[10] = new TMatrixD(24,24);
  CovarianceCopy[11] = new TMatrixD(24,24);
  CovarianceCopy[12] = new TMatrixD(24,24);
  CovarianceCopy[13] = new TMatrixD(24,24);
  CovarianceCopy[14] = new TMatrixD(24,24);
  CovarianceCopy[15] = new TMatrixD(12,12);
  CovarianceCopy[16] = new TMatrixD(12,12);
  CovarianceCopy[17] = new TMatrixD(6,6);
  CovarianceCopy[18] = new TMatrixD(6,6);
  CovarianceCopy[19] = new TMatrixD(1,1);
  CovarianceCopy[20] = new TMatrixD(1,1);
  CovarianceCopy[21] = new TMatrixD(1,1);
  CovarianceCopy[22] = new TMatrixD(1,1);
  CovarianceCopy[23] = new TMatrixD(1,1);
  ...
  for (Int_t i = 1; i < 101; i++) {
    ...
    *CovarianceCopy[Stripe] = *Covariance[Stripe];
    ...
    // -------------------------
    averagerhoH->SetBinContent( i*20, rho[i-1] );
    averagerhoH->SetBinError(   i*20, 0. );
  }
  new TCanvas;
  BeautifyPad();
  ...
  averagerhoH->GetYaxis()->SetRangeUser(averagerhoH->GetBinContent(2000)*0.99,1.001);
  if( Stripe == 5  ) averagerhoH->GetYaxis()->SetRangeUser(0.650,1.000);
  if( Stripe == 6  ) averagerhoH->GetYaxis()->SetRangeUser(0.650,1.000);
  if( Stripe == 7  ) averagerhoH->GetYaxis()->SetRangeUser(0.940,0.990);
  if( Stripe == 8  ) averagerhoH->GetYaxis()->SetRangeUser(0.950,0.990);
  if( Stripe == 9  ) averagerhoH->GetYaxis()->SetRangeUser(0.994,1.000);
  if( Stripe == 10 ) averagerhoH->GetYaxis()->SetRangeUser(0.984,1.002);
  if( Stripe == 11 ) averagerhoH->GetYaxis()->SetRangeUser(0.974,1.000);
  if( Stripe == 12 ) averagerhoH->GetYaxis()->SetRangeUser(0.981,1.000);
  if( Stripe == 13 ) averagerhoH->GetYaxis()->SetRangeUser(0.9965,1.000);
  if( Stripe == 15 ) averagerhoH->GetYaxis()->SetRangeUser(0.920,0.990);
  if( Stripe == 16 ) averagerhoH->GetYaxis()->SetRangeUser(0.940,0.990);
  if( Stripe == 17 ) averagerhoH->GetYaxis()->SetRangeUser(0.650,1.000);
  if( Stripe == 18 ) averagerhoH->GetYaxis()->SetRangeUser(0.650,1.000);
  averagerhoH->GetXaxis()->SetRangeUser(-0.5, 1999.5);
  averagerhoH->Draw();
  latex5->DrawLatex(0.31,0.94,"Pb-Pb #sqrt{#it{s}_{NN}} = 5.02 TeV");
  latex5->DrawLatex(0.31,0.74,Form("This thesis, Slice in cos#theta = %d", Stripe));
  gPad->SaveAs(Form("Unfolding2D/Convergence/average-rho-modulation-%d.pdf", Stripe), "recreate");
