...
TMatrixD* Covariance4  = new TMatrixD(1,1);
TMatrixD* Covariance5  = new TMatrixD(6,6);
TMatrixD* Covariance6  = new TMatrixD(6,6);
TMatrixD* Covariance7  = new TMatrixD(12,12);
TMatrixD* Covariance8  = new TMatrixD(12,12);
TMatrixD* Covariance9  = new TMatrixD(24,24);
TMatrixD* Covariance10 = new TMatrixD(24,24);
TMatrixD* Covariance11 = new TMatrixD(24,24);
TMatrixD* Covariance12 = new TMatrixD(24,24);
TMatrixD* Covariance13 = new TMatrixD(24,24);
TMatrixD* Covariance14 = new TMatrixD(24,24);
TMatrixD* Covariance15 = new TMatrixD(12,12);
TMatrixD* Covariance16 = new TMatrixD(12,12);
TMatrixD* Covariance17 = new TMatrixD(6,6);
TMatrixD* Covariance18 = new TMatrixD(6,6);
TMatrixD* Covariance19 = new TMatrixD(1,1);
...
void FcnForMinimisation(Int_t & /*nPar*/, Double_t * /*grad*/ , Double_t &fval, Double_t *p, Int_t /*iflag */  )
{
  ...
  for ( Int_t i = 0; i < n; ++i ) {
    ...
    if ( values[i] != 0 ) {
      ...
      cout << "========================" << endl;
      cout << values[i] - helicity2Dv2( x, p ) << endl;
      cout << errors[i] << endl;
      cout << "tmp = " << tmp << endl;
    } else {
      tmp = 0;
...
//_____________________________________________________________________________
void FcnForMinimisationWithBinsCovariance(Int_t & /*nPar*/, Double_t * /*grad*/ , Double_t &fval, Double_t *p, Int_t /*iflag */  )
{
  Int_t n = coordsX.size();
  Double_t chi2 = 0;
  Double_t tmp, tmp2, x[2], y[2], x2[2], y2[2];
  Double_t Determinant[24];
  Covariance4->InvertFast(&Determinant[4]);
  Covariance5->InvertFast(&Determinant[5]);
  Covariance6->InvertFast(&Determinant[6]);
  Covariance7->InvertFast(&Determinant[7]);
  Covariance8->InvertFast(&Determinant[8]);
  Covariance9->InvertFast(&Determinant[9]);
  Covariance10->InvertFast(&Determinant[10]);
  Covariance11->InvertFast(&Determinant[11]);
  Covariance12->InvertFast(&Determinant[12]);
  Covariance13->InvertFast(&Determinant[13]);
  Covariance14->InvertFast(&Determinant[14]);
  Covariance15->InvertFast(&Determinant[15]);
  Covariance16->InvertFast(&Determinant[16]);
  Covariance17->InvertFast(&Determinant[17]);
  Covariance18->InvertFast(&Determinant[18]);
  Covariance19->InvertFast(&Determinant[19]);
  TMatrixD CovarianceInvert4(1,1);
  TMatrixD CovarianceInvert5(6,6);
  TMatrixD CovarianceInvert6(6,6);
  TMatrixD CovarianceInvert7(12,12) ;
  TMatrixD CovarianceInvert8(12,12);
  TMatrixD CovarianceInvert9(24,24) ;
  TMatrixD CovarianceInvert10(24,24) ;
  TMatrixD CovarianceInvert11(24,24);
  TMatrixD CovarianceInvert12(24,24);
  TMatrixD CovarianceInvert13(24,24);
  TMatrixD CovarianceInvert14(24,24);
  TMatrixD CovarianceInvert15(12,12);
  TMatrixD CovarianceInvert16(12,12);
  TMatrixD CovarianceInvert17(6,6);
  TMatrixD CovarianceInvert18(6,6);
  TMatrixD CovarianceInvert19(1,1);
  CovarianceInvert4  = *Covariance4;
  CovarianceInvert5  = *Covariance5;
  CovarianceInvert6  = *Covariance6;
  CovarianceInvert7  = *Covariance7;
  CovarianceInvert8  = *Covariance8;
  CovarianceInvert9  = *Covariance9;
  CovarianceInvert10 = *Covariance10;
  CovarianceInvert11 = *Covariance11;
  CovarianceInvert12 = *Covariance12;
  CovarianceInvert13 = *Covariance13;
  CovarianceInvert14 = *Covariance14;
  CovarianceInvert15 = *Covariance15;
  CovarianceInvert16 = *Covariance16;
  CovarianceInvert17 = *Covariance17;
  CovarianceInvert18 = *Covariance18;
  CovarianceInvert19 = *Covariance19;
  // CovarianceInvert4.Print();
  // CovarianceInvert5.Print();
  // CovarianceInvert6.Print();
  // CovarianceInvert7.Print();
  // CovarianceInvert8.Print();
  // CovarianceInvert9.Print();
  // CovarianceInvert10.Print();
  // CovarianceInvert11.Print();
  // CovarianceInvert12.Print();
  // CovarianceInvert13.Print();
  // CovarianceInvert14.Print();
  // CovarianceInvert15.Print();
  // CovarianceInvert16.Print();
  // CovarianceInvert17.Print();
  // CovarianceInvert18.Print();
  // CovarianceInvert19.Print();


  // cout << "entering the loop" << endl;

  // for ( Int_t i = 0; i < n; ++i ) {
  //   cout << "coordsX[" << i << "] = " << coordsX[i] << endl;
  // }
  ...
  for ( Int_t j = 0; j < n; ++j ) {
    ...
    // Double_t TraslatedCosThetaGen = 0.5*(coordsY[i] + 1.)*24.;
    Double_t TraslatedCosThetaGen = 0.5*(x[1] + 1.)*24.;
    Double_t iCosThetaBins2 = -1;
    Double_t RemainderCosTheta = 0.;
    RemainderCosTheta = modf(TraslatedCosThetaGen, &iCosThetaBins2);
    Int_t iCosThetaBins = (Int_t)  iCosThetaBins2;
    ...
    // Double_t TraslatedCosThetaGenJ = 0.5*(coordsY[j] + 1.)*24.;
    Double_t TraslatedCosThetaGenJ = 0.5*(x2[1] + 1.)*24.;
    Double_t iCosThetaBins2J = -1;
    Double_t RemainderCosThetaJ = 0.;
    RemainderCosThetaJ = modf(TraslatedCosThetaGenJ, &iCosThetaBins2J);
    Int_t iCosThetaBinsJ = (Int_t)  iCosThetaBins2J;
    ...
    // Double_t TraslatedPhiGen = coordsX[i]*M/(2.*TMath::Pi());
    Double_t TraslatedPhiGen = x[0]*M/(2.*TMath::Pi());
    Double_t iPhiBins2 = -1;
    Double_t RemainderPhi = 0.;
    RemainderPhi = modf(TraslatedPhiGen, &iPhiBins2);
    Int_t iPhiBins = (Int_t)  iPhiBins2;

    // Double_t TraslatedPhiGenJ = coordsX[j]*M/(2.*TMath::Pi());
    Double_t TraslatedPhiGenJ = x2[0]*M/(2.*TMath::Pi());
    Double_t iPhiBins2J = -1;
    Double_t RemainderPhiJ = 0.;
    RemainderPhiJ = modf(TraslatedPhiGenJ, &iPhiBins2J);
    Int_t iPhiBinsJ = (Int_t)  iPhiBins2J;
    ...
    // cout << "======================================" << endl;
    // cout << "(i,yj)=" << i << "," << j << endl;
    // cout << "Chi2 computation, (x,y)="<< y[0] << "," << y[1] << "      (x2,y2)="<< y2[0] << "," << y2[1]   << endl;

    if (iCosThetaBins != iCosThetaBinsJ) {
      continue;
    } else if (iCosThetaBins == iCosThetaBinsJ) {
      // cout << "Chi2 computation2" << endl;
      tmp = 0.;
      tmp = ( values[i] - IntegralFunction(y, p) )*
            ( values[j] - IntegralFunction(y2,p));
      // cout << "Chi2 computation3, tmp = " << tmp << endl;
      if(        iCosThetaBins == 4 ){
        tmp *= CovarianceInvert4(y[0], y2[0]);
      } else if( iCosThetaBins == 5 ){
        tmp *= CovarianceInvert5(y[0], y2[0]);
      } else if( iCosThetaBins == 6 ){
        tmp *= CovarianceInvert6(y[0], y2[0]);
      } else if( iCosThetaBins == 7 ){
        tmp *= CovarianceInvert7(y[0], y2[0]);
      } else if( iCosThetaBins == 8 ){
        tmp *= CovarianceInvert8(y[0], y2[0]);
      } else if( iCosThetaBins == 9 ){
        tmp *= CovarianceInvert9(y[0], y2[0]);
      } else if( iCosThetaBins == 10 ){
        tmp *= CovarianceInvert10(y[0], y2[0]);
      } else if( iCosThetaBins == 11 ){
        tmp *= CovarianceInvert11(y[0], y2[0]);
      } else if( iCosThetaBins == 12 ){
        tmp *= CovarianceInvert12(y[0], y2[0]);
      } else if( iCosThetaBins == 13 ){
        tmp *= CovarianceInvert13(y[0], y2[0]);
      } else if( iCosThetaBins == 14 ){
        tmp *= CovarianceInvert14(y[0], y2[0]);
      } else if( iCosThetaBins == 15 ){
        tmp *= CovarianceInvert15(y[0], y2[0]);
      } else if( iCosThetaBins == 16 ){
        tmp *= CovarianceInvert16(y[0], y2[0]);
      } else if( iCosThetaBins == 17 ){
        tmp *= CovarianceInvert17(y[0], y2[0]);
      } else if( iCosThetaBins == 18 ){
        tmp *= CovarianceInvert18(y[0], y2[0]);
      } else if( iCosThetaBins == 19 ){
        tmp *= CovarianceInvert19(y[0], y2[0]);
      }
      // cout << "Chi2 computation4, tmp = " << tmp << endl;
...
//_____________________________________________________________________________
void FcnForMinimisationCovarianceSimple(Int_t & /*nPar*/, Double_t * /*grad*/ , Double_t &fval, Double_t *p, Int_t /*iflag */  )
{
  Int_t n = coordsX.size();
  Double_t chi2 = 0;
  Double_t tmp, tmp2, x[2], y[2], x2[2], y2[2];
  Double_t Determinant[24];
  TMatrixD CovarianceCopy4(1,1);
  TMatrixD CovarianceCopy5(6,6);
  TMatrixD CovarianceCopy6(6,6);
  TMatrixD CovarianceCopy7(12,12) ;
  TMatrixD CovarianceCopy8(12,12);
  TMatrixD CovarianceCopy9(24,24) ;
  TMatrixD CovarianceCopy10(24,24) ;
  TMatrixD CovarianceCopy11(24,24);
  TMatrixD CovarianceCopy12(24,24);
  TMatrixD CovarianceCopy13(24,24);
  TMatrixD CovarianceCopy14(24,24);
  TMatrixD CovarianceCopy15(12,12);
  TMatrixD CovarianceCopy16(12,12);
  TMatrixD CovarianceCopy17(6,6);
  TMatrixD CovarianceCopy18(6,6);
  TMatrixD CovarianceCopy19(1,1);
  CovarianceCopy4  = *Covariance4;
  CovarianceCopy5  = *Covariance5;
  CovarianceCopy6  = *Covariance6;
  CovarianceCopy7  = *Covariance7;
  CovarianceCopy8  = *Covariance8;
  CovarianceCopy9  = *Covariance9;
  CovarianceCopy10 = *Covariance10;
  CovarianceCopy11 = *Covariance11;
  CovarianceCopy12 = *Covariance12;
  CovarianceCopy13 = *Covariance13;
  CovarianceCopy14 = *Covariance14;
  CovarianceCopy15 = *Covariance15;
  CovarianceCopy16 = *Covariance16;
  CovarianceCopy17 = *Covariance17;
  CovarianceCopy18 = *Covariance18;
  CovarianceCopy19 = *Covariance19;
  // Covariance4->InvertFast(&Determinant[4]);
  // Covariance5->InvertFast(&Determinant[5]);
  // Covariance6->InvertFast(&Determinant[6]);
  // Covariance7->InvertFast(&Determinant[7]);
  ...
  CovarianceCopy4.InvertFast(&Determinant[4]);
  CovarianceCopy5.InvertFast(&Determinant[5]);
  CovarianceCopy6.InvertFast(&Determinant[6]);
  CovarianceCopy7.InvertFast(&Determinant[7]);
  CovarianceCopy8.InvertFast(&Determinant[8]);
  CovarianceCopy9.InvertFast(&Determinant[9]);
  CovarianceCopy10.InvertFast(&Determinant[10]);
  CovarianceCopy11.InvertFast(&Determinant[11]);
  CovarianceCopy12.InvertFast(&Determinant[12]);
  CovarianceCopy13.InvertFast(&Determinant[13]);
  CovarianceCopy14.InvertFast(&Determinant[14]);
  CovarianceCopy15.InvertFast(&Determinant[15]);
  CovarianceCopy16.InvertFast(&Determinant[16]);
  CovarianceCopy17.InvertFast(&Determinant[17]);
  CovarianceCopy18.InvertFast(&Determinant[18]);
  CovarianceCopy19.InvertFast(&Determinant[19]);
  ...
  // CovarianceInvert18 = *Covariance18;
  // CovarianceInvert19 = *Covariance19;
  CovarianceInvert4  = CovarianceCopy4;
  CovarianceInvert5  = CovarianceCopy5;
  CovarianceInvert6  = CovarianceCopy6;
  CovarianceInvert7  = CovarianceCopy7;
  CovarianceInvert8  = CovarianceCopy8;
  CovarianceInvert9  = CovarianceCopy9;
  CovarianceInvert10 = CovarianceCopy10;
  CovarianceInvert11 = CovarianceCopy11;
  CovarianceInvert12 = CovarianceCopy12;
  CovarianceInvert13 = CovarianceCopy13;
  CovarianceInvert14 = CovarianceCopy14;
  CovarianceInvert15 = CovarianceCopy15;
  CovarianceInvert16 = CovarianceCopy16;
  CovarianceInvert17 = CovarianceCopy17;
  CovarianceInvert18 = CovarianceCopy18;
  CovarianceInvert19 = CovarianceCopy19;
  // CovarianceInvert4.Print();
  // CovarianceInvert5.Print();
  // CovarianceInvert6.Print();
  // CovarianceInvert7.Print();
  ...
  for ( Int_t j = 0; j < n; ++j ) {
    ...
    if (iCosThetaBins != iCosThetaBinsJ) {
      ...
      // cout << "Chi2 computation2" << endl;
      tmp = 0.;
      // tmp = ( values[i] - helicity2Dv3(x, p) )*
      //       ( values[j] - helicity2Dv3(x2,p));
      tmp = ( values[i] - IntegralFunction(y, p) )*
            ( values[j] - IntegralFunction(y2,p));
      // cout << "Chi2 computation3, tmp = " << tmp << endl;
      // tmp *= 1./(errors[i]*errors[j]);
      if(        iCosThetaBins == 4 ){
        tmp *= CovarianceInvert4(y[0], y2[0]);
        // tmp /= CovarianceInvert4(y[0], y2[0]);
      } else if( iCosThetaBins == 5 ){
        // cout << "======================================" << endl;
        // cout << "(i,yj)=" << i << "," << j << endl;
        // cout << (values[i] - helicity2Dv3(x, p)) << endl;
        // cout << (values[j] - helicity2Dv3(x2, p)) << endl;
        // cout << "Chi2 computation3, tmp = " << tmp << endl;
        tmp *= CovarianceInvert5(y[0], y2[0]);
        // tmp /= CovarianceInvert5(y[0], y2[0]);
        // cout << "Chi2 computation4, tmp = " << tmp << endl;
...
// void PolarisationHeMinuit2D( Int_t SignalRangeSelectionMode = 0, Int_t FitRangeMode = 0 ){
  ...
  TMatrixD CovarianceUncertT5(6,6);
  ...
  for (Int_t i = 4; i < 20; i++) {
    ...
    // unfold[i] = (RooUnfoldBayes) f[i]->Get("response;2");
    // h[i] = (TH1F*) f[i]->Get(Form("histo3_%d", i));
  }

  Covariance4  = (TMatrixD*)f[4]->Get("TMatrixT<double>;1");
  Covariance5  = (TMatrixD*)f[5]->Get("TMatrixT<double>;2");
  Covariance6  = (TMatrixD*)f[6]->Get("TMatrixT<double>;3");
  Covariance7  = (TMatrixD*)f[7]->Get("TMatrixT<double>;4");
  Covariance8  = (TMatrixD*)f[8]->Get("TMatrixT<double>;5");
  Covariance9  = (TMatrixD*)f[9]->Get("TMatrixT<double>;6");
  Covariance10 = (TMatrixD*)f[10]->Get("TMatrixT<double>;7");
  Covariance11 = (TMatrixD*)f[11]->Get("TMatrixT<double>;8");
  Covariance12 = (TMatrixD*)f[12]->Get("TMatrixT<double>;9");
  Covariance13 = (TMatrixD*)f[13]->Get("TMatrixT<double>;10");
  Covariance14 = (TMatrixD*)f[14]->Get("TMatrixT<double>;11");
  Covariance15 = (TMatrixD*)f[15]->Get("TMatrixT<double>;12");
  Covariance16 = (TMatrixD*)f[16]->Get("TMatrixT<double>;13");
  Covariance17 = (TMatrixD*)f[17]->Get("TMatrixT<double>;14");
  Covariance18 = (TMatrixD*)f[18]->Get("TMatrixT<double>;15");
  Covariance19 = (TMatrixD*)f[19]->Get("TMatrixT<double>;16");
  ...
  Model2->SetParameter(3, Normalisation);
...
//______________________________________________
void DrawResidual(Int_t Iterations = 0){
  ...
  for (Int_t i = 4; i < 20; i++) {
    ...
    h3[i] = (TH1F*) h2[i]->Clone(Form("histo5_%d", i));
  ...
  gPad->SaveAs(Form("Unfolding2D/residuals-closure-%d.pdf", Iterations), "recreate");
...
void DrawDifferences2D(){
  ...
  latex->SetTextSize(0.055);
  latex->DrawLatex(0.7,0.94,"Helicity");
  latex->DrawLatex(0.7,0.74,"This thesis");

  gPad->SaveAs("Unfolding2D/unfolded-reconstructed.pdf",  "RECREATE");
  ...
  latex3->SetTextSize(0.055);
  latex3->DrawLatex(0.7,0.94,"Helicity generated");
  latex3->DrawLatex(0.7,0.74,"This thesis");

  gPad->SaveAs("Unfolding2D/generated.pdf",  "RECREATE");
  ...
  latex4->SetTextSize(0.055);
  latex4->DrawLatex(0.7,0.94,"Helicity");
  latex4->DrawLatex(0.7,0.74,"This thesis");
  latex4->DrawLatex(0.7,0.66,"Residuals");

  gPad->SaveAs("Unfolding2D/residuals-2D.pdf",  "RECREATE");
  new TCanvas;
  histo4->Draw("surf");
}
//_____________________________________________________________________________
...
void DrawUncertainties(){
  ...
  latex4->DrawLatex(0.6,0.80,"Uncertainties");
  latex4->DrawLatex(0.6,0.74,"This thesis, 1 iteration");

  gPad->SaveAs("Unfolding2D/uncertainties-1.pdf",  "RECREATE");
  new TCanvas;
  histo4->Draw("surf");
}
//_____________________________________________________________________________
void DrawRefolded(Int_t Iterations = 0)
{
  new TCanvas;
  gPad->SetMargin(0.13,0.10,0.12,0.10);
  gPad->SetTickx(1);
  ...
  TFile* file = new TFile("Unfolding2D/UnfoldedClosureHe_10.root");
  ...
  else {latex5->DrawLatex(0.31,0.72,Form("%d iterations", Iterations));}
  latex5->DrawLatex(0.2,0.80,Form("#chi^{2} = #sum (Refolded - REC)^{2}/REC = %0.02f", ChiSquareTest));

  gPad->SaveAs(Form("Unfolding2D/residual-refolded-%d.pdf", Iterations), "recreate");
}
//______________________________________________
void DrawResidualV2(Int_t Iterations = 0){
  ...
  for (Int_t i = 4; i < 20; i++) {
    ...
    h[i]  = (TH1F*) f[i]->Get(Form("histo3_%d", i));
    h2[i] = (TH1F*) f[i]->Get(Form("histo4_%d", i));
    h3[i] = (TH1F*) h2[i]->Clone(Form("histo7_%d", i));
    // h3[i] = (TH1F*) f[i]->Get(Form("histo4_%d", i));
    h3[i]->Sumw2();
    // h8[i]->Sumw2();
    h2[i]->Sumw2();
  ...
  gPad->SaveAs(Form("Unfolding2D/esiduals-closure-%d.pdf", Iterations), "recreate");
...
void DrawResidualV3(Int_t Iterations = 0){
  ...
  TH1F*  GenH[24];
  TH1F*  UnfoldedH[24];
  TH1F*  UnfoldedCopyH[24];
  TH1F*  h8[24];
  Int_t Counter = 1;
  Double_t Values[250];
  Double_t NormUnfold[250];
  Double_t NormGen[250];
  Double_t TotalNormUnfold = 0;
  Double_t TotalNormGen = 0;
  Double_t ChiSquareTest = 0;
  Double_t ChiSquareTest2 = 0;
  Int_t M = 1;
  TH1F* DifferencesH = new TH1F("DifferencesH","DifferencesH", 300, -0.5, 299.5);
  TH1F* RatioH       = new TH1F("RatioH",      "RatioH",       300, -0.5, 299.5);
  for (Int_t i = 4; i < 20; i++) {
    f[i] = new TFile(Form("Unfolding2D/UnfoldedClosureHe_%d.root", i));
    GenH[i]  = (TH1F*) f[i]->Get(Form("histo3_%d", i));
    UnfoldedH[i] = (TH1F*) f[i]->Get(Form("histo4_%d", i));
    UnfoldedCopyH[i] = (TH1F*) UnfoldedH[i]->Clone(Form("histo7_%d", i));
    UnfoldedCopyH[i]->Sumw2();
    UnfoldedH[i]->Sumw2();
    GenH[i]->Sumw2();
    if( i == 0  || i == 1  || i == 2  || i == 3  ||
        i == 4  || i == 23 || i == 22 || i == 21 ||
    ...
    ChiSquareTest2 += calcChi2(GenH[i], UnfoldedH[i], M);
    // UnfoldedCopyH[i] -> Add(GenH[i], -1.);
    h8[i] = (TH1F*) UnfoldedCopyH[i]->Clone(Form("histo8_%d", i));
    h8[i]->Sumw2();
    h8[i] ->Divide(UnfoldedCopyH[i],GenH[i], 1,1, "B");
    // new TCanvas;
    // h8[i]->Draw();
    for (Int_t j = 1; j < 31; j++) {
      if (GenH[i]->GetBinContent(j) > 0.00000000000001) {
        DifferencesH->SetBinContent(Counter, (UnfoldedH[i]->GetBinContent(j)-GenH[i]->GetBinContent(j))/GenH[i]->GetBinContent(j));
        DifferencesH->SetBinError(Counter, 0.000000000000000000);
        RatioH->SetBinContent(Counter, (UnfoldedH[i]->GetBinContent(j))/GenH[i]->GetBinContent(j));
        RatioH->SetBinError(Counter, 0.000000000000000000);
        // Values[Counter] = (UnfoldedH[i]->GetBinContent(j)-GenH[i]->GetBinContent(j))*(UnfoldedH[i]->GetBinContent(j)-GenH[i]->GetBinContent(j))/UnfoldedH[i]->GetBinContent(j);
        ...
        NormUnfold[Counter] = UnfoldedH[i]->GetBinContent(j);
        NormGen[Counter]    = GenH[i]->GetBinContent(j);
        TotalNormUnfold    += UnfoldedH[i]->GetBinContent(j);
        TotalNormGen       += GenH[i]->GetBinContent(j);
        cout << "Values[" << Counter << "] = " << Values[Counter] << endl;
        ChiSquareTest += Values[Counter];
        Counter++;
      }
  ...
  // latex5->DrawLatex(0.2,0.64,Form("#chi^{2} = #sum (Unfolded REC - GEN)^{2}/GEN = %0.02f", ChiSquareTest));
  latex5->DrawLatex(0.2,0.64,Form("#chi^{2} = #sum (Unfolded REC - GEN)^{2}/GEN = %0.02f", ChiSquareTest2));
  latex5->DrawLatex(0.2,0.54,Form("NormU/NormG = %0.04f / %0.04f = %0.05f", TotalNormUnfold/100000000., TotalNormGen/100000000., TotalNormUnfold/TotalNormGen));
  ...
  TH1F* histogram2 = (TH1F*) RatioH->Clone("histogram2");
  ...
  histogram2->SetTitle("");
  histogram2->GetXaxis()->SetTitleOffset(1.15);
  histogram2->GetYaxis()->SetTitleOffset(1.45);
  histogram2->GetXaxis()->SetTitleSize(0.045);
  histogram2->GetYaxis()->SetTitleSize(0.045);
  histogram2->GetXaxis()->SetLabelSize(0.045);
  histogram2->GetYaxis()->SetLabelSize(0.045);
  histogram2->GetXaxis()->SetTitleFont(42);
  histogram2->GetYaxis()->SetTitleFont(42);
  histogram2->GetXaxis()->SetLabelFont(42);
  histogram2->GetYaxis()->SetLabelFont(42);

  histogram2->GetXaxis()->SetTitle("Bin number");
  histogram2->GetYaxis()->SetTitle("Unfolded REC/GEN [a.u.]");
  // histogram2->GetYaxis()->SetRangeUser(-0.006,0.004);
  histogram2->GetYaxis()->SetRangeUser(0.90,1.10);
  histogram2->GetXaxis()->SetRangeUser(-0.5, 217.5);
  // histogram2->GetXaxis()->SetRangeUser(100, 600);
  histogram2->SetLineWidth(5);
  ...
  gPad->SaveAs(Form("Unfolding2D/ratio-closure-%d.pdf", Iterations), "recreate");
