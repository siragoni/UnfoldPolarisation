...
void PolarisationHeMinuit2D(Int_t FitRangeMode = 0, Int_t Iterations = 1, Int_t StripeMode = 0 ){
  ...
  for (Int_t i = 4; i < 20; i++) {
    f[i]         = new TFile(Form("ScanModulation/LPhi02/UnfoldingModulation/UnfoldedClosureHe_phimodulation_differentprior_%d.root", i));
  ...
  gPad->SaveAs(Form("ScanModulation/LPhi02/FittingModulation/residual-refolded-data-%d.pdf", Iterations), "recreate");
  ...
  gMinuit->DefineParameter(1, "LambdaPhi",           1., 0.1,    -2, 2        );
  ...
  latex->DrawLatex(0.8,0.94,"Modulation");
  ...
  gPad->SaveAs(Form("ScanModulation/LPhi02/FittingModulation/2Dmaps-data-%d.pdf", Iterations), "recreate");
  ...
  histo2->Fit("Model", "R");
  gPad->SaveAs(Form("ScanModulation/LPhi02/FittingModulation/3D-data-%d.pdf", Iterations), "recreate");
  ...
  gPad->SaveAs("ScanModulation/LPhi02/FittingModulation/residuals-data.pdf", "recreate");
...
void FitGeneratedModulation(){
  ...
  TFile* f = new TFile("ScanModulation/LPhi02/ModulationYields/MonteCarloYieldsHe_phimodulation_10.root");
  ...
  latex->SetTextSize(0.055);
  latex->DrawLatex(0.7,0.94,"Modulation");

  gPad->SaveAs("ScanModulation/LPhi02/FittingModulation/generated_phimodulation.pdf",  "RECREATE");
...
// void PolarisationHeMinuit2D( Int_t SignalRangeSelectionMode = 0, Int_t FitRangeMode = 0 ){
  ...
  TH1F*  h[24];
  for (Int_t i = 4; i < 20; i++) {
    f[i] = new TFile(Form("ScanModulation/LPhi02/ModulationYields/MonteCarloYieldsHe_phimodulation_%d.root", i));
  ...
  gPad->SaveAs("ScanModulation/LPhi02/FittingModulation/generated-modulation-binning-data.pdf",  "RECREATE");
  ...
  latexD->SetNDC();
  latexD->DrawLatex(0.31,0.94,"This thesis, Pb-Pb #sqrt{#it{s}_{NN}} = 5.02 TeV");
  gPad->SaveAs("ScanModulation/LPhi02/FittingModulation/residuals-generated-modulationphi.pdf", "recreate");
