...
void UnfoldWithFit(Int_t RangeFlag = 0, Int_t TriggerFlag = 0){
  ...
  Double_t CosThetaCSrec2;
  Double_t CosThetaCSgen2;
  ...
  Double_t TildePhiCSposrec2;
  Double_t TildePhiCSposgen2;
  ...
  Double_t TildePhiCSnegrec2;
  Double_t TildePhiCSneggen2;
  ...
  for (Int_t i=0; i<nentriesRec; i++) {
    ...
    if(        TriggerFlag == 1 ) {
      ...
      if( (pTgen > 0. && pTgen < 0.25) && (Ygen > -4. && Ygen < -2.5) && (TriggerSelectionFlag > 0.5) ) {
          PhiGenH     ->Fill( (PhiCSgen+TMath::Pi()) );
          CosThetaGenH->Fill( CosThetaCSgen          );
          CosThetaCSgen2 = -1.*CosThetaCSgen;
          PhiCSgen2 = PhiCSgen;
          /* -
           ...
           */
           ...
           TildePhiCSposgen2  = PhiCSgen2 - 1.25 * TMath::Pi() ;
           TildePhiCSneggen2  = PhiCSgen2 - 1.75 * TMath::Pi() ;
          if( TildePhiCSposgen2 < 0. ) {
            TildePhiCSposgen2 += 2. * TMath::Pi();
          }
          if( TildePhiCSposgen2 < 0. ) {
            TildePhiCSposgen2 += 2. * TMath::Pi();
          }
          if( TildePhiCSneggen2 < 0. ) {
            TildePhiCSneggen2 += 2. * TMath::Pi();
          }
          if( TildePhiCSneggen2 < 0. ) {
            TildePhiCSneggen2 += 2. * TMath::Pi();
          }
          ...
          Costhetahelp = CosThetaCSgen2;
          Costhetahelp2 = CosThetaCSrec - CosThetaCSgen2;
          phihelp2 = PhiCSrec - PhiCSgen2;
          if ( CosThetaCSgen2 > 0. ){
              TildePhiGenH->Fill( TildePhiCSposgen2 );
          } else {
              TildePhiGenH->Fill( TildePhiCSneggen2 );
          }
          if( (pTrec > 0. && pTrec < 0.25) && (Yrec > -4. && Yrec < -2.5) ) {
              ...
              if( (PhiCSrec+TMath::Pi()) > 0. && (PhiCSrec+TMath::Pi()) < 2.*TMath::Pi() ){
                  if(PhiCSrec < 0.) PhiCSrec = PhiCSrec + 2.*TMath::Pi();
                  // responsePhi.Fill( (PhiHErec+TMath::Pi()), (PhiHEgen2+TMath::Pi()) );
                  responsePhi.Fill( PhiCSrec, (PhiCSgen2+TMath::Pi()) );
                  // PhiRecH->Fill( (PhiHErec+TMath::Pi()) );
                  PhiRecH->Fill( PhiCSrec );

                  // PhiRecMinusGenH->Fill(PhiHErec-phihelp);
                  PhiRecMinusGenH->Fill(PhiCSrec - (PhiCSgen2+TMath::Pi()));
                  ...
                  **/
                  TildePhiCSposrec2  = PhiCSrec - 0.25 * TMath::Pi() ;
                  TildePhiCSnegrec2  = PhiCSrec - 0.75 * TMath::Pi() ;
                  // TildePhiHEposrec2  = PhiHErec - 1.*TMath::Pi() - 0.25 * TMath::Pi() ;
                  // TildePhiHEnegrec2  = PhiHErec - 1.*TMath::Pi() - 0.75 * TMath::Pi() ;
                  if( TildePhiCSposrec2 < 0. ) {
                    TildePhiCSposrec2 += 2. * TMath::Pi();
                  }
                  if( TildePhiCSnegrec2 < 0. ) {
                    TildePhiCSnegrec2 += 2. * TMath::Pi();
                  }
                  if ( CosThetaCSrec > 0. ){
                      // if( TildePhiHEposrec2 > 0. && TildePhiHEposrec2 < 2.*TMath::Pi() ){
                          responseTildePhi.Fill( TildePhiCSposrec2, TildePhiCSposgen2 );
                          TildePhiRecH->Fill( TildePhiCSposrec2 );
                      // }
                  } else {
                      // if( TildePhiHEnegrec2 > 0. && TildePhiHEnegrec2 < 2.*TMath::Pi() ){
                          responseTildePhi.Fill( TildePhiCSnegrec2, TildePhiCSneggen2 );
                          TildePhiRecH->Fill( TildePhiCSnegrec2 );
                      // }
                  }
              ...
              //     }
              // }
              if( CosThetaCSrec > -1. && CosThetaCSrec < 1. ){
                  responseCosTheta.Fill( CosThetaCSrec, CosThetaCSgen2 );
                  CosThetaRecH->Fill( CosThetaCSrec );
                  ...
                  responsePhi.Miss( (PhiCSgen2+TMath::Pi()) );
                  if ( CosThetaCSgen2 > 0. ){
                      responseTildePhi.Miss( TildePhiCSposgen2 );
                  } else {
                      responseTildePhi.Miss( TildePhiCSneggen2 );
                  }
                  responseCosTheta.Miss( CosThetaCSgen2 );
  ...
  // TH1F *DataCosTheta         = (TH1F*)fileDataRawCosTheta->Get("CosThetaAfterSignalExtractionErrorsH");
  if(        TriggerFlag == 1 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger1/TildePhiCSv2.root.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger1/PhiCSv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger1/CosThetaCsFrame.root");
  } else if( TriggerFlag == 2 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger2/TildePhiCSv2.root.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger2/PhiCSv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger2/CosThetaCsFrame.root");
  } else if( TriggerFlag == 3 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger3/TildePhiCSv2.root.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger3/PhiCSv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger3/CosThetaCsFrame.root");
  } else if( TriggerFlag == 4 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger4/TildePhiCSv2.root.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger4/PhiCSv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger4/CosThetaCsFrame.root");
  } else if( TriggerFlag == 5 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger5/TildePhiCSv2.root.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger5/PhiCSv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger5/CosThetaCsFrame.root");
  } else if( TriggerFlag == 6 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger6/TildePhiCSv2.root.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger6/PhiCSv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger6/CosThetaCsFrame.root");
  } else if( TriggerFlag == 7 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger7/TildePhiCSv2.root.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger7/PhiCSv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger7/CosThetaCsFrame.root");
  } else {
    fileDataRawTildePhi = new TFile("RealData/TildePhiCsFrameV2.root");
    fileDataRawPhi      = new TFile("RealData/PhiCsFrameV2.root");
    fileDataRawCosTheta = new TFile("RealData/CosThetaCsFrame.root");
  }
  TH1F *DataTildePhi         = (TH1F*)fileDataRawTildePhi->Get("TildePhiAfterSignalExtractionErrorsH");
  TH1F *DataPhi              = (TH1F*)fileDataRawPhi->Get("PhiAfterSignalExtractionErrorsH");
  TH1F *DataCosTheta         = (TH1F*)fileDataRawCosTheta->Get("CosThetaAfterSignalExtractionErrorsH");
...
void PolarisationHeMinuit1D( TH1* CorrectedCosTheta, TH1* CorrectedPhi, TH1* CorrectedTildePhi, Int_t FitRangeMode = 0, Int_t SignalRangeSelectionMode = 0 ){
  ...
  Model->SetNpx(500);
  Model->Draw("same");
  if ( SignalRangeSelectionMode == 0 || FitRangeMode == 0 ) gPad->SaveAs("CosThetaCsMinuit.png", "recreate");
  gPad->SaveAs(Form("CosThetaHeMinuit_SigEx_%d_FitRange_%d_CS.png", SignalRangeSelectionMode, FitRangeMode), "recreate");
  ...
  Model2->SetNpx(500);
  Model2->Draw("same");
  if ( SignalRangeSelectionMode == 0 || FitRangeMode == 0 ) gPad->SaveAs("PhiCsMinuit.png", "recreate");
  gPad->SaveAs(Form("PhiHeMinuit_SigEx_%d_FitRange_%d_CS.png", SignalRangeSelectionMode, FitRangeMode), "recreate");
  ...
  Model3->SetNpx(500);
  Model3->Draw("same");
  if ( SignalRangeSelectionMode == 0 || FitRangeMode == 0 ) gPad->SaveAs("TildePhiCsMinuit.png", "recreate");
  gPad->SaveAs(Form("TildePhiHeMinuit_SigEx_%d_FitRange_%d_CS.png", SignalRangeSelectionMode, FitRangeMode), "recreate");
