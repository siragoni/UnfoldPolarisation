...
void UnfoldWithFit(Int_t RangeFlag = 0, Int_t TriggerFlag = 0){
  ...
  TFile* file   = new TFile("AnalysisResultsLongit.root", "READ");
  ...
  if(        TriggerFlag == 1 ) {
    ...
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger1/CosThetaCS/CosThetaCsFrame.root");
  } else if( TriggerFlag == 2 ) {
    fileDataRawTildePhi = new TFile("RealData/TildePhiCsFrameV2.root");
    fileDataRawPhi      = new TFile("RealData/PhiCsFrameV2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger2/CosThetaCS/CosThetaCsFrame.root");
  } else if( TriggerFlag == 3 ) {
    fileDataRawTildePhi = new TFile("RealData/TildePhiCsFrameV2.root");
    fileDataRawPhi      = new TFile("RealData/PhiCsFrameV2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger3/CosThetaCS/CosThetaCsFrame.root");
  } else if( TriggerFlag == 4 ) {
    fileDataRawTildePhi = new TFile("RealData/TildePhiCsFrameV2.root");
    fileDataRawPhi      = new TFile("RealData/PhiCsFrameV2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger4/CosThetaCS/CosThetaCsFrame.root");
  } else if( TriggerFlag == 5 ) {
    fileDataRawTildePhi = new TFile("RealData/TildePhiCsFrameV2.root");
    fileDataRawPhi      = new TFile("RealData/PhiCsFrameV2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger5/CosThetaCS/CosThetaCsFrame.root");
  } else if( TriggerFlag == 6 ) {
    fileDataRawTildePhi = new TFile("RealData/TildePhiCsFrameV2.root");
    fileDataRawPhi      = new TFile("RealData/PhiCsFrameV2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger6/CosThetaCS/CosThetaCsFrame.root");
  } else if( TriggerFlag == 7 ) {
    fileDataRawTildePhi = new TFile("RealData/TildePhiCsFrameV2.root");
    fileDataRawPhi      = new TFile("RealData/PhiCsFrameV2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger7/CosThetaCS/CosThetaCsFrame.root");
  } else {
    fileDataRawTildePhi = new TFile("RealData/TildePhiCsFrameV2.root");
    fileDataRawPhi      = new TFile("RealData/PhiCsFrameV2.root");
...
void PolarisationHeMinuit1D( TH1* CorrectedCosTheta, TH1* CorrectedPhi, TH1* CorrectedTildePhi, Int_t FitRangeMode = 0, Int_t SignalRangeSelectionMode = 0 ){
  ...
  gMinuit->DefineParameter(1, "NormalTheta", 19000, 100,  10000., 2.4e+04);
  ...
  gMinuit->DefineParameter(4, "NormalisTildePhi",  4500, 100,  3500, 6500);
