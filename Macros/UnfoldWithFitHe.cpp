...
void UnfoldWithFit(Int_t RangeFlag = 0, Int_t TriggerFlag = 0){
  ...
  // TH1F *DataCosTheta         = (TH1F*)fileDataRawCosTheta->Get("CosThetaAfterSignalExtractionErrorsH");
  if(        TriggerFlag == 1 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger1/TildePhiHEv2.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger1/PhiHEv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger1/CosThetaHeFrame.root");
  } else if( TriggerFlag == 2 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger2/TildePhiHEv2.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger2/PhiHEv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger2/CosThetaHeFrame.root");
  } else if( TriggerFlag == 3 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger3/TildePhiHEv2.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger3/PhiHEv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger3/CosThetaHeFrame.root");
  } else if( TriggerFlag == 4 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger4/TildePhiHEv2.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger4/PhiHEv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger4/CosThetaHeFrame.root");
  } else if( TriggerFlag == 5 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger5/TildePhiHEv2.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger5/PhiHEv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger5/CosThetaHeFrame.root");
  } else if( TriggerFlag == 6 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger6/TildePhiHEv2.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger6/PhiHEv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger6/CosThetaHeFrame.root");
  } else if( TriggerFlag == 7 ) {
    fileDataRawTildePhi = new TFile("TriggerUncert/PolTrigger7/TildePhiHEv2.root");
    fileDataRawPhi      = new TFile("TriggerUncert/PolTrigger7/PhiHEv2.root");
    fileDataRawCosTheta = new TFile("TriggerUncert/PolTrigger7/CosThetaHeFrame.root");
  } else {
